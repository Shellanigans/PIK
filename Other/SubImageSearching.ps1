Add-Type -Namespace TEST -Name TEST -ReferencedAssemblies System.Drawing -IgnoreWarnings -MemberDefinition @'
public static System.Collections.Generic.List<System.Drawing.Point> GetSubPositions(System.Drawing.Bitmap main, System.Drawing.Bitmap sub) {
    System.Collections.Generic.List<System.Drawing.Point> possiblepos = new System.Collections.Generic.List<System.Drawing.Point>();
    ...
    System.Drawing.Imaging.BitmapData bmMainData = main.LockBits(new System.Drawing.Rectangle(0, 0, mainwidth, mainheight), System.Drawing.Imaging.ImageLockMode.ReadWrite, System.Drawing.Imaging.PixelFormat.Format32bppArgb);
    System.Drawing.Imaging.BitmapData bmSubData = sub.LockBits(new System.Drawing.Rectangle(0, 0, subwidth, subheight), System.Drawing.Imaging.ImageLockMode.ReadWrite, System.Drawing.Imaging.PixelFormat.Format32bppArgb);
...
$Bounds = [GUI.Rect]::R(100,100,1820,980)
...
$Bounds2 = [GUI.Rect]::R(659,1005,30,30)

$BMP2 = New-Object System.Drawing.Bitmap -ArgumentList ($Bounds2.Width, $Bounds2.Height)
            
$Graphics2 = [System.Drawing.Graphics]::FromImage($BMP2)
$Graphics2.CopyFromScreen($Bounds2.Location, [System.Drawing.Point]::Empty, $Bounds2.size)

[TEST.TEST]::GetSubPositions()
